...
var store = new _vuex.default.Store({
  ...
  mutations: {
    ...
    logoutStore: function logoutStore() {
      state.token = '';
      state.isLog = false;
    },
